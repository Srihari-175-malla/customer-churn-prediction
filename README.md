...
Explore the code and methodology in the [Jupyter Notebook](Customer_Churn_Prediction.ipynb). This notebook includes all the steps for data preprocessing, feature engineering, model training, and evaluation.
...
```bash
git clone https://github.com/Srihari-175-malla/customer-churn-prediction.git
